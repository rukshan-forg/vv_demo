import GraphicsDesignImage from "../assets/hireBg.jpg"; // Replace with your actual image path
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row-reverse items-center">
                ...
                <div ref={ref}
                    ...
                    <p className="mt-4 text-lg text-gray-500">
                        Our graphic design services help you create a visual identity that stands out. We specialize in custom designs that reflect your brand's personality.
                    </p>
                    ...
                    <ul className="mt-4 space-y-4">
                        <li className="flex">
                            ...
                            <span className="text-gray-500">Brand Identity Creation</span>
                        </li>
                        <li className="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-500 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6M9 8h6" />
                            </svg>
                            <span className="text-gray-500">Custom Illustrations</span>
                        </li>
                        <li className="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-500 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 17h8m-4-4v8m0-8h8" />
                            </svg>
                            <span className="text-gray-500">Print and Digital Media</span>
                        </li>
                    </ul>

                    <div className="mt-8">
                        <a href="/graphics" className="inline-block px-6 py-3 text-white font-semibold bg-blue-600 rounded-md hover:bg-blue-700 transition">
                            Learn More
                        </a>
                    </div>
                </div>
